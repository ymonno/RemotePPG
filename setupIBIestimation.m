...
urlFastICA = 'https://research.ics.aalto.fi/ica/fastica/code/FastICA_2.5.zip';
filenameFastICA = '.';
unzip(urlFastICA,filenameFastICA)

% install facial landmark detection
disp('Installing find_face_landmarks...')
urlFind_dace_landmark = 'https://github.com/YuvalNirkin/find_face_landmarks/releases/download/1.2/find_face_landmarks-1.2-x64-vc14-release.zip';
